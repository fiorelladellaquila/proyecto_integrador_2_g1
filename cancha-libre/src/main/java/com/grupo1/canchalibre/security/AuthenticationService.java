...
public class AuthenticationService {
    ...
    public void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException {
        try {
            ...
            String verifyURL = "https://localhost:3000" + "/auth/verify-confirmation?code=" + user.getVerificationCode();
    ...
    public void renovarPasswordSendCode(String email) throws MessagingException, UnsupportedEncodingException {
        try {
            ...
            String verifyURL = "http://localhost:3000/auth/reset_password?code=" + user1.getVerificationCode() + "&email=" + email;
